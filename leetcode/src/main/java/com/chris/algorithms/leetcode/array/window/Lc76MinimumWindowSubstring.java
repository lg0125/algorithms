...
/** 最小覆盖子串
 ...
 测试链接 : <a href="https://leetcode.cn/problems/minimum-window-substring/">...</a>
 */
public class Lc76MinimumWindowSubstring {
    public static class Solution {
        public static String minWindow(String str, String tar) {
            ...
            // 最小覆盖子串的长度
            int len = Integer.MAX_VALUE, len_t = t.length, len_s = s.length;

            // 从哪个位置开头，发现的这个最小覆盖子串
            int start = 0;
            for (int l = 0, r = 0, debt = len_t; r < len_s; r++) {
                // s[r] 当前字符 -> int
