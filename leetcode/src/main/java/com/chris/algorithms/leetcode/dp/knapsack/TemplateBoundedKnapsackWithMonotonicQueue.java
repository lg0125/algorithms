 ...
 */
public class TemplateBoundedKnapsackWithMonotonicQueue {
    public static class Solution {
        public static int MAX_N = 101;

        public static int MAX_W = 40001;
        ...
        public static int[] dp = new int[MAX_W];
        public static int[] queue = new int[MAX_W];
        ...
        private static int value1(int[][] dp, int i, int j) {
