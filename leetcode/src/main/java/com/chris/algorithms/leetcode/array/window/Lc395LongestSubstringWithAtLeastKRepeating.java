...
/** 至少有K个重复字符的最长子串
 ...
 如果不存在这样的子字符串，则返回 0。
 测试链接 : <a href="https://leetcode.cn/problems/longest-substring-with-at-least-k-repeating-characters/">...</a>
 */
public class Lc395LongestSubstringWithAtLeastKRepeating {
