...
/** 替换子串得到平衡字符串
 ...
 测试链接 : <a href="https://leetcode.cn/problems/replace-the-substring-for-balanced-string/">...</a>
 */
public class LC1234ReplaceTheSubstringForBalancedString {
    public static class Solution {
        ...
        // 返回值 : 请问能不能做到
        private static boolean ok(int[] cnts, int len, int require) {
            for (int i = 0; i < 4; i++) {
                // 0 1 2 3
                if (cnts[i] > require)
                    return false;
