...
/** 统计整数数目
 ...
 测试链接 : <a href="https://leetcode.cn/problems/count-of-integers/">...</a>
 */
public class Lc2719CountOfIntegers {
    public static class Solution {
        public static int MOD = 1000000007;
        public static int MAX_N = 23;
        public static int MAX_M = 401;

        public static int[][][] dp = new int[MAX_N][MAX_M][2];
